...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('conversion_rate', models.DecimalField(decimal_places=2, default=0.5, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorystore', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.categorystore')),
        ...
        migrations.AddField(
            ...
            name='typestore',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.typestore'),
        ),
        migrations.CreateModel(
            name='UserLocation',
            fields=[
